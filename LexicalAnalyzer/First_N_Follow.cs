...
namespace LexicalAnalyzer
{
    public static class First_N_Follow
    {
        ...
        public static string[] FirstClass_Body1 = new string[] { "AM", "AM", "DT", "ID", "abstract" };
        ...
        public static string[] FirstDecl_Init = new string[] { "AM", "AM", "DT", "ID", "abstract" };
        public static string[] FollowDecl_Init = new string[] { "AM", "AM", "DT", "ID", "abstract" };
        public static string[] FirstDecl = new string[] { "DT", "ID", "abstract" };
        public static string[] FollowDecl = new string[] { "AM", "AM", "DT", "ID", "abstract" };
        public static string[] FirstAss = new string[] { "assign" };
        public static string[] FollowAss = new string[] { "(", "ID", "new" };
        public static string[] FirstDec3 = new string[] { "ID" };
        public static string[] FollowDec3 = new string[] { "AM", "AM", "DT", "ID", "abstract" };
        public static string[] FirstDec4 = new string[] { "ID", "{" };
        public static string[] FollowDec4 = new string[] { "AM", "AM", "DT", "ID", "abstract" };
        ...
        public static string[] FirstAM = new string[] { "AM", "AM", "null" };
        public static string[] FollowAM = new string[] { "DT","ID", "abstract" };
        public static string[] FirstBody = new string[] { "ter", "for", "while","do","if", "switch", "AM", "AM", "DT", "ID", "abstract", "return", "break", "continue", "ID", "{"  };
        ...
        public static string[] FirstExp = new string[] { "||", "&&", "PM", "RO", "MDM", "ROP", "ID", "int_const", "float_const", "string_const", "char_const", "(", "!", "inc", "dec", "this", "base" };
        public static string[] FollowExp = new string[] { "'", "ter", ")", ",", ":", "]", "}" };
        public static string[] FirstAnd = new string[] { "&&" ,"ID", "int_const", "float_const", "string_const", "char_const", "(", "!", "inc", "dec","this", "base" };
